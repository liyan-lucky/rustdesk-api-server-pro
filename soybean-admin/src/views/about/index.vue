...
const defaultCommandTemplate = 'IMAGE=ghcr.io/liyan-lucky/rustdesk-api-server-pro:{version} EXPECTED_VERSION={version} /vol1/docker/rustdesk-api-server-pro/update-rustdesk-api.sh';
